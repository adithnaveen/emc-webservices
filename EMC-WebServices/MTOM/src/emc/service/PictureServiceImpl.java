...
@WebService(targetNamespace="http://serivce.emc/", 
	name="PictureService", endpointInterface="emc.service.PictureService")
@MTOM
public class PictureServiceImpl implements PictureService{
	...
	public Picture getPicture(String shortName) {
		...
		throw new RuntimeException("Sorry Image Name Not Matching...");
